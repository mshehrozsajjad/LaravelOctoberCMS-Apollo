  ...
  return function(t) {
        ...
        if ("undefined" != typeof window) {
          ...
          var s = function(t) {
            if ("string" == typeof t) {
              ...
              return e.history.indexOf(t) > -1
                ? e[t].elements = i
                : (e[t] = (0, r.default)(i, n), e.history.push(t)),
              e[t]
            }
          };
          return s.offset = function(t) {
            ...
            return ["top", "right", "bottom", "left"].forEach(
              e(t)
              ? function(e) {
                return n.offset[e] = t
              }
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e, n) {
        ...
        return e = r(e) || 0,
        i(n) && (
          k = !!n.leading, O = "maxWait" in n, x = O
          ? s(r(n.maxWait) || 0, e)
          : x,
        T = "trailing" in n
          ? !!n.trailing
...
function(t) {
  t(document).ready(function() {
    ...
    inView(".page-content").on("enter", function() {
      e.addClass("active")
    }).on("exit", function() {
